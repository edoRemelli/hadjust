function [] = display_model_debug(centers,blocks,radii, face_alpha, figure_mode, varargin)
...
% gotta do this if not there is a bug :/
%min_distances = min_distances + 1e-06;
